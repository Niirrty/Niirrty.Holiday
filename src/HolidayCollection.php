...
class HolidayCollection implements ArrayAccess, IteratorAggregate, Countable
{
     ...
     */
    public function __construct( private readonly int $year, private readonly string $countryName,
     ...
     */
    public function offsetGet( $offset ) : Holiday
    {
     ...
     * @throws \Throwable
     */
    public function containsDate( mixed $date, string &$foundIdentifier = null ): bool
    {
        ...
        $dateString = '' . $this->year . $dt->format( '-m-d' );
    ...
    public function containsDay( int $month, int $day, string &$foundIdentifier = null ): bool
    {
        ...
        $dt = DateTime::Create( $this->year, $month, $day );
    ...
    public function startsAt( int $month = 1, int $day = 1 ): HolidayCollection
    {
        ...
        $result = ( new HolidayCollection( $this->year, $this->countryName, $this->countryId ) )
        ...
        $minDate = DateTime::Create( $this->year, $month, $day );
    ...
    public function byRegionName( string $regionName ): HolidayCollection
    {
        ...
        {
            return ( new HolidayCollection( $this->year, $this->countryName, $this->countryId ) )
                ->setRegions( $this->_regions );
        }
